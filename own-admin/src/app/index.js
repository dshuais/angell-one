...
//   format: err => { // 开发环境
//     return { code: err.status, msg: err.message }
//   },
//   postFormat: (err, obj) => { // 生成环境
//     return obj
//   }
// }))
...
app.use(KoaStatic(path.join(__dirname, '../../../dushuai_koa2_server.com'))) // 默认暴露的静态资源 前端项目
